    ...
    for hashtag in target_hashtags:
        ...
        for tweet1, tweet2, label in predictions:
            ...
            if key in gold_dict and key not in checked_pairs:
                ...
                #print("gold_label:{}".format(gold_label))
                if label == gold_label:
                    cur_correct += 1
        #print("gold dict:{}".format(gold_dict))
        print("gold dict:{}".format(len(gold_dict)))
...
def load_gold_file(filename):
    ...
    top10_list = []
    nontop10_list = []
    #list of dictonarries one for each score
    label_list_dict = {
        '0': nontop10_list,
        '1': top10_list,
        '2': win_list,
    ...
    with open(filename, 'r') as f:
        ...
        for row in reader:
            ...
            #add the tweet to the dictonary with a matching score
